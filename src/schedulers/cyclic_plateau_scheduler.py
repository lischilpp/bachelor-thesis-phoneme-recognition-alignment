...
class CyclicPlateauScheduler():
    ...
    def __init__(self, steps_per_epoch, optimizer, initial_lr=0.001, min_lr=1e-8, min_improve_factor=0.999, lr_patience=0, lr_reduce_factor=0.5, lr_reduce_metric='loss'):
        super().__init__()
        self.lr = initial_lr
        self.min_lr = min_lr
    ...
    def validation_epoch_end(self, metrics): # plateau scheduler
        ...
        if reduce_metric_val > self.last_lr_metric_val * self.min_improve_factor:
